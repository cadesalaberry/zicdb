...
public class cli {
	public enum State {
		INDEX, HOME, SIGNIN, SIGNUP, VIEWARTISTS, VIEWALBUMS, 
		VIEWALBUM, ADDSONG, VIEWPLAYLISTS, VIEWLIKEDPLAYLIST,
		VIEWLIKEDPLAYLISTS, VIEWPLAYLIST, VIEWMYPLAYLISTS, VIEWMYPLAYLIST, CREATEPLAYLIST
	}
	...
	public static void main(String[] args) {
		...
		System.out.println("Welcome to ZicDb. Where all you zicz are belong to us ");
		while(!quit)
		{
			switch (state){
				case INDEX:
					...
					System.out.println("Enter a number to chose one of the options below ");
				...
				case HOME:
					...
					System.out.println("2 - Browse1 Playlists ");
				...
				case VIEWARTISTS:
					...
					viewArtists();
					System.out.println("Enter the artist number you want to browse or type 'back' to go back");
				...
				case VIEWALBUMS:
					...
					System.out.println("ZicDB -- BROWSE SONGS ");
					viewAlbums(artist);
					System.out.println("Enter the album number you want to browse or type 'back' to go back");
				...
				case VIEWALBUM:
					...
					System.out.println("ZicDB -- BROWSE SONGS ");
					viewAlbum(album);
					System.out.println("Type 'add' to add a song or 'back' to go back");
				...
				case ADDSONG:
					...
					System.out.println (addSongToAlbum(album, inputSong, inputLink, inputLinkSource));
					state = State.VIEWALBUM;
				...
				case VIEWMYPLAYLISTS:
					...
					System.out.println("Enter the playlist number to browse it or 'back' to go back");
				...
				case VIEWPLAYLIST:
					...
					System.out.println("Type 'like' to like playlist or 'back' to go back");
				...
				case VIEWLIKEDPLAYLIST:
					...
					System.out.println("ZicDB -- BROWSE PLAYLIST ");
					viewPlaylist(playlist);
					System.out.println("Type 'unlike' to unlike playlist or 'back' to go back");
	...
	// function that checks credentials of user
	public static boolean isValidUser(String user, String password)
	{
		return (user.equals("ben") && password.equals("poops"));
	}
	
	//function that checks if user already exists in database
	public static boolean isExistingUser(String user){
		return (user.equals("ben"));
	}
	...
	public static String addSongToAlbum(int album, String song, String link, String linkSource){
	...
	public static void viewMyPlaylists(String user){
		System.out.println("--- VIEWING ALL PLAYLISTS BY USER "+ user + " -- ");
	}
	...
	public static void unlikePlaylist (String user, int playlist){
		System.out.println("--- USER "+ user + " unlikes playlist " + playlist);
	}
